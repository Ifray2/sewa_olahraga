...
@section('content')
    ...
    <form method="POST" action="{{ route('petugas.equipment.update', $equipment) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div style="display:flex;flex-direction:column;gap:1.5rem;">
                ...
                <div class="table-card">
                    <div class="table-card-header">
                        ...
                        <a href="{{ route('petugas.equipment.show', $equipment) }}" class="btn-outline">Lihat Detail</a>
                    </div>
    ...
    <form id="delete-form" method="POST" action="{{ route('petugas.equipment.destroy', $equipment) }}"
