        ...
        <div style="display:flex;flex-direction:column;gap:1.5rem;">
            ...
            <div class="table-card" style="overflow:hidden;">
                ...
                <div style="padding:1rem 1.5rem;border-top:1px solid var(--border);display:flex;gap:.5rem;">
                    <a href="{{ route('petugas.equipment.edit', $equipment) }}" class="btn-add" style="flex:1;justify-content:center;">Edit</a>
                    <form method="POST" action="{{ route('petugas.equipment.toggle', $equipment) }}" style="flex:1;">
                        @csrf @method('PATCH')
        ...
        <div style="display:flex;flex-direction:column;gap:1.5rem;">
            ...
            <div class="table-card">
                <div class="table-card-header">
                    ...
                    <a href="{{ route('petugas.rentals.index') }}?equipment_id={{ $equipment->id }}" class="btn-outline">Lihat Semua</a>
                </div>
