...
@section('content')
    <form method="POST" action="{{ route('petugas.payments.store') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div style="display:flex;flex-direction:column;gap:1.5rem;position:sticky;top:70px;">
                ...
                <div class="table-card">
                    ...
                    <div style="padding:1rem 1.25rem;display:flex;flex-direction:column;gap:.5rem;">
                        ...
                        <a href="{{ route('petugas.payments.index') }}" class="btn-outline" style="justify-content:center;padding:.65rem;">
                            Batal
                        </a>
                    </div>
                </div>
