        ...
        <div style="display:flex;flex-direction:column;gap:1.5rem;">
            ...
            <div class="table-card">
                <div class="table-card-header">
                    ...
                    <a href="{{ route('petugas.payments.edit', $payment) }}" class="btn-outline">Edit</a>
                </div>
            ...
            <div class="table-card">
                <div class="table-card-header">
                    ...
                    <a href="{{ route('petugas.rentals.show', $payment->rental) }}" class="btn-outline">Lihat Transaksi</a>
                </div>
                <div style="padding:1.5rem;">
            ...
            <div class="table-card">
                ...
                <div style="padding:1.25rem;display:flex;flex-direction:column;gap:.5rem;">
                    ...
                    @if($payment->status === 'unpaid')
                        <form method="POST" action="{{ route('petugas.payments.verify', $payment) }}"
                    ...
                    @if($payment->status === 'paid')
                        <form method="POST" action="{{ route('petugas.payments.refund', $payment) }}"
                    ...
                    <a href="{{ route('petugas.payments.edit', $payment) }}" class="btn-outline" style="justify-content:center;padding:.65rem;">
                        ✎ Edit Pembayaran
                    </a>

                    <a href="{{ route('petugas.rentals.show', $payment->rental) }}" class="btn-outline" style="justify-content:center;padding:.65rem;">
                        📋 Lihat Transaksi
                    </a>
                </div>
            </div>
            ...
            @if($payment->status !== 'paid')
                <div class="table-card" style="border-color:rgba(248,113,113,.2);">
                    ...
                    <div style="padding:1.25rem;">
                        ...
                        <form method="POST" action="{{ route('petugas.payments.destroy', $payment) }}"
