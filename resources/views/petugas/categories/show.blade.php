    ...
    <div style="display:grid;grid-template-columns:340px 1fr;gap:1.5rem;align-items:start;">
        ...
        <div style="display:flex;flex-direction:column;gap:1.5rem;">
            ...
            <div class="table-card">
                ...
                <div style="padding:1rem 1.5rem;border-top:1px solid var(--border);display:flex;gap:.5rem;">
                    <a href="{{ route('petugas.categories.edit', $category) }}" class="btn-add" style="flex:1;justify-content:center;">
                        Edit
                    </a>
                    <form method="POST" action="{{ route('petugas.categories.toggleStatus', $category) }}" style="flex:1;">
                        @csrf @method('PATCH')
        ...
        <div class="table-card">
            <div class="table-card-header">
                ...
                <a href="{{ route('petugas.equipment.create') }}?category={{ $category->id }}" class="btn-add">
                    + Tambah Alat
                </a>
            </div>
            ...
            @else
                <div style="padding:3rem;text-align:center;color:var(--mid);">
                    ...
                    <a href="{{ route('petugas.equipment.create') }}?category={{ $category->id }}" class="btn-add" style="display:inline-flex;">
                        + Tambah Alat Pertama
                    </a>
                </div>
            @endif
