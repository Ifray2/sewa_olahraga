<x-app-layout>
    <x-slot name="heading">Alat Olahraga</x-slot>
            ...
            <div class="table-card-actions">
                <form method="GET" style="display:flex;gap:.5rem;flex-wrap:wrap;align-items:center;">
                    ...
                    @if(request('search') || request('category_id') || request('condition') || request('status') !== null)
                        <a href="{{ route('admin.equipment.index') }}" class="btn-outline">Reset</a>
                    @endif
                </form>
                <a href="{{ route('admin.equipment.create') }}" class="btn-add">+ Tambah Alat</a>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-group">
                                <a href="{{ route('admin.equipment.show', $item) }}" class="btn-action btn-view">Lihat</a>
                                <a href="{{ route('admin.equipment.edit', $item) }}" class="btn-action btn-edit">Edit</a>
                                <form method="POST" action="{{ route('admin.equipment.toggle', $item) }}" style="display:inline;">
                                    @csrf @method('PATCH')
                                ...
                                <form method="POST" action="{{ route('admin.equipment.destroy', $item) }}" style="display:inline;"
                ...
                @empty
                    <tr>
                        <td colspan="9" style="text-align:center;padding:3rem;color:var(--mid);">
                            ...
                            <a href="{{ route('admin.equipment.create') }}" class="btn-add" style="display:inline-flex;margin-top:1rem;">+ Tambah Alat</a>
                        </td>
                    </tr>
                @endforelse
            </tbody>
