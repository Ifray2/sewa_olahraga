            ...
            <div class="table-card-actions">
                <form method="GET" style="display:flex;gap:.5rem;flex-wrap:wrap;align-items:center;">
                    ...
                    @if(request()->hasAny(['search','status','method','date_from','date_to']))
                        <a href="{{ route('admin.payments.index') }}" class="btn-outline">Reset</a>
                    @endif
                </form>
                <a href="{{ route('admin.payments.create') }}" class="btn-add">+ Tambah Pembayaran</a>
            </div>
        </div>
            ...
            <tbody>
                @forelse($payments as $i => $payment)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.rentals.show', $payment->rental) }}"
                        ...
                        <td>
                            <div class="action-group">
                                <a href="{{ route('admin.payments.show', $payment) }}" class="btn-action btn-view">Lihat</a>
                                <a href="{{ route('admin.payments.edit', $payment) }}" class="btn-action btn-edit">Edit</a>
