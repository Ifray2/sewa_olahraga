<x-app-layout>
    <x-slot name="heading">Edit Kategori</x-slot>
        ...
        <div class="table-card">
            <div class="table-card-header">
                ...
                <div style="display:flex;gap:.5rem;">
                    <a href="{{ route('admin.categories.show', $category) }}" class="btn-outline">Lihat Detail</a>
                </div>
            </div>

            <form method="POST" action="{{ route('admin.categories.update', $category) }}" style="padding:1.75rem;">
                @csrf
                @method('PUT')
