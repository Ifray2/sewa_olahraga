...
class petugasRentalController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('petugas.rentals.index', compact('rentals', 'summary'));
    }
    ...
    public function create()
    {
        ...
        return view('petugas.rentals.create', compact('equipment', 'users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('petugas.rentals.index')
    ...
    public function show(Rental $rental)
    {
        ...
        return view('petugas.rentals.show', compact('rental'));
    }
    ...
    public function edit(Rental $rental)
    {
        ...
        $users     = User::where('role', 'user')->orderBy('name')->get();
        $staff     = User::whereIn('role', ['petugas', 'petugas'])->orderBy('name')->get();

        return view('petugas.rentals.edit', compact('rental', 'equipment', 'users', 'staff'));
    }
    ...
    public function update(Request $request, Rental $rental)
    {
        ...
        return redirect()->route('petugas.rentals.show', $rental)
